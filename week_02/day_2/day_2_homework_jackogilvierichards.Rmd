...
```{r}
wrestlers <- dbGetQuery(conn = wrestling_db_connection, statement = "SELECT * FROM wrestling")
...
```{r}
remote_wresters <- dbGetQuery(conn = wrestling_db_connect, statement = "SELECT * FROM wrestling")
```
